...
$("div.btn-input").live('click', function(){
    ...
    btn.addClass('active btn-primary');
		...
		<?php 
		echo "<CENTER><IMG SRC='cikungunya.jpg' WIDTH='300' HEIGHT='300' BORDER=0 ALT=''></CENTER>";
		if(!isset($_GET['idpertanyaan'])){
		//tampilkan pertanyaan pertama
			$sqlp = "select * from diagnosa_cikungunya where mulai='Y'";
			$rs=mysql_query($sqlp);
		...
		//tampilkan pertanyaan pertama
			...
			$sqlp = "select * from diagnosa_cikungunya where id=$idsolusi";
